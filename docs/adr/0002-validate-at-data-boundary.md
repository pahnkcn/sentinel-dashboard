...
weeks `0/8/16`, bounded strings, and known fields. Do not coerce numeric
strings. Quarantine invalid records and mark the entire data state degraded so
analytics fail closed.
