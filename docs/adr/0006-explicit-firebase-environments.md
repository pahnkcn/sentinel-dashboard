...
Force Vite development mode to fixed localhost Auth and Firestore emulators
using a tracked demo project. Forbid emulators in production. Require a
reCAPTCHA Enterprise App Check site key for every remote mode. Keep the tracked
Firebase CLI default pointed at the demo project and require an explicit
